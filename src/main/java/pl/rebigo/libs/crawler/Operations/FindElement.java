...
public class FindElement {
     ...
     */
    public WebElement start(By locator, Integer timeoutMSec, Integer pollingEvery, WebDriver webDriver) {
        for (Integer count = 0; count < timeoutMSec; count += pollingEvery){
            log.debug(String.format("Check exist web element. Count seconds: %1$s of %2$s.", count / 1000, timeoutMSec / 1000));
